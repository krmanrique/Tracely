...
export const mockData = {
  student: {
    ...
    bySemester: {
      ...
      "2024-2": {
        ...
        notifications: [{ id: 1, type: "success", courseId: null, message: "Promedio 3.9 — ¡Buen semestre!", time: "Hace 3h", read: false }],
  ...
  teacher: {
    ...
    bySemester: {
      ...
      "2025-2": { courses: [], schedule: [] },
    },
  },

  // ── ADMIN ────────────────────────────────────────────────────
  admin: {
    name: "Admin UNICATÓLICA",
    id: "ADM-001",
    role: "Administrador",
    avatar: null,
    ...
    students: [
      { id: "2021-0342", name: "Michael Sanchez", program: "Ing. Sistemas", semester: 6, gpa: 4.1, attendance: 87, status: "active", risk: "low" },
      { id: "2021-0199", name: "Valentina Torres", program: "Ing. Sistemas", semester: 6, gpa: 3.9, attendance: 92, status: "active", risk: "low" },
      { id: "2022-0411", name: "Andrés Mejía", program: "Ing. Sistemas", semester: 4, gpa: 2.8, attendance: 65, status: "risk", risk: "high" },
      { id: "2022-0087", name: "Sara Quintero", program: "Administración", semester: 4, gpa: 4.3, attendance: 88, status: "active", risk: "low" },
      { id: "2023-0512", name: "Miguel Ángel Ríos", program: "Ing. Sistemas", semester: 2, gpa: 2.1, attendance: 45, status: "critical", risk: "critical" },
      { id: "2023-0304", name: "Laura Fernández", program: "Contaduría", semester: 3, gpa: 4.7, attendance: 97, status: "active", risk: "low" },
      { id: "2022-0198", name: "Juan Prado", program: "Ing. Civil", semester: 5, gpa: 3.2, attendance: 78, status: "warning", risk: "medium" },
      { id: "2021-0501", name: "Camila Rojas", program: "Psicología", semester: 7, gpa: 4.0, attendance: 90, status: "active", risk: "low" },
    ],

    teachers: [
      { id: "DOC-0112", name: "Dr. Carlos Ramírez", department: "Ing. Sistemas", courses: 2, students: 60, avgAttendance: 82, status: "active" },
      { id: "DOC-0087", name: "Dra. Ospina", department: "Matemáticas", courses: 3, students: 95, avgAttendance: 79, status: "active" },
      { id: "DOC-0221", name: "Mg. Vargas", department: "Ing. Sistemas", courses: 2, students: 58, avgAttendance: 85, status: "active" },
      { id: "DOC-0155", name: "Ing. Morales", department: "Telecomunicaciones", courses: 1, students: 30, avgAttendance: 77, status: "active" },
      { id: "DOC-0309", name: "Dr. Cárdenas", department: "Matemáticas", courses: 2, students: 62, avgAttendance: 88, status: "active" },
    ],

    recentActivity: [
      { id: 1, type: "alert", message: "Miguel Ángel Ríos — asistencia crítica (45%)", time: "Hace 30 min", severity: "critical" },
      { id: 2, type: "grade", message: "Dr. Ramírez publicó notas Corte 1 — IS-401 G1", time: "Hace 2h", severity: "info" },
      { id: 3, type: "alert", message: "Andrés Mejía — riesgo de deserción detectado", time: "Hace 3h", severity: "high" },
      { id: 4, type: "user", message: "3 nuevos estudiantes matriculados en IS-301", time: "Hace 5h", severity: "info" },
      { id: 5, type: "system", message: "Respaldo automático de base de datos completado", time: "Hace 6h", severity: "success" },
      { id: 6, type: "alert", message: "Juan Prado — asistencia bajo 80% en IS-405", time: "Ayer", severity: "medium" },
    ],

    programStats: [
      { name: "Ing. Sistemas", students: 1240, avgGpa: 3.8, retention: 90 },
      { name: "Administración", students: 980, avgGpa: 3.6, retention: 88 },
      { name: "Contaduría", students: 760, avgGpa: 3.9, retention: 93 },
      { name: "Psicología", students: 640, avgGpa: 3.7, retention: 92 },
      { name: "Ing. Civil", students: 598, avgGpa: 3.5, retention: 87 },
    ],
  },
};
